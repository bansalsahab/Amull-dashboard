...
import { ArrowDown, ArrowUp, AlertTriangle, TrendingUp, Target, CheckCircle2, DollarSign, Users } from "lucide-react"
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg font-semibold">
                Daily Business Pulse - {new Date().toLocaleDateString()}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start">
                      <span className="bg-green-200 text-green-800 rounded-full w-4 h-4 flex items-center justify-center text-xs mr-2 mt-0.5">
                        +
                      </span>
                ...
                <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start">
                      <span className="bg-red-200 text-red-800 rounded-full w-4 h-4 flex items-center justify-center text-xs mr-2 mt-0.5">
                        !
                      </span>
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start">
                      <span className="bg-blue-200 text-blue-800 rounded-full w-4 h-4 flex items-center justify-center text-xs mr-2 mt-0.5">
                        →
                      </span>
